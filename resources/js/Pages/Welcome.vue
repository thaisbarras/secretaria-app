...
<template>
    <Head title="Welcome" />
    <div class="bg-gray-50 text-white/50 dark:bg-white dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]" />
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <img src="/images/logo_uerj_fat.png" alt="">   
                    </div>
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        ...
                        <template v-else>
                            ...
                            <a 
                                href="home" 
                                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-black dark:hover:text-black/80 dark:focus-visible:ring-black">Home
                            </a>
                            <Link
                                v-if="canRegister"
                                :href="route('register')"
